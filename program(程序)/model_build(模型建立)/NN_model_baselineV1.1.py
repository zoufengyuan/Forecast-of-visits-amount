...
train_db = tf.data.Dataset.from_tensor_slices((train_x,train_hash_category_df,train_y)).shuffle(train_x.shape[0]).batch(128)
test_db = tf.data.Dataset.from_tensor_slices((test_x,test_hash_category_df,test_y)).shuffle(test_x.shape[0]).batch(128)
val_db = tf.data.Dataset.from_tensor_slices((test_x[:1000],test_hash_category_df[:1000],test_y[:1000])).shuffle(1000).batch(128)
...
class Network(keras.Model):
    def __init__(self):
        ...
        self.fc1 = layers.Dense(256,activation = 'relu')#带L2正则项
        #self.dropout_1 = layers.Dropout(0.5)
        #self.fc2 = layers.Dense(32,activation = 'relu')
        self.fc2 = layers.Dense(256,activation = 'relu')#带L2正则项
        #self.dropout_2 = layers.Dropout(0.5)#dropout
        self.fc3 = layers.Dense(256,activation = 'relu')
        
        self.fc4 = layers.Dense(196,activation = 'relu')
        
        self.fc5 = layers.Dense(196,activation = 'relu')
        
        self.fc6 = layers.Dense(196,activation = 'relu')
        
        self.fc7 = layers.Dense(128,activation = 'relu')
        self.fc8 = layers.Dense(128,activation = 'relu')
        self.fc9 = layers.Dense(128,activation = 'relu')
        
        self.fc10 = layers.Dense(64,activation = 'relu')
        self.fc11 = layers.Dense(64,activation = 'relu')
        self.fc12 = layers.Dense(64,activation = 'relu')
        
        
        self.fc13 = layers.Dense(32,activation = 'relu')
        self.fc14 = layers.Dense(32,activation = 'relu')
        self.fc15 = layers.Dense(32,activation = 'relu')
